		...
		<article id="comment-<?php comment_ID(); ?>" class="clearfix">
			<div class="comment-author vcard row clearfix">
				...
				<div class="span10 comment-text">
					...
					<?php edit_comment_link(__('Edit','bonestheme'),'<span class="edit-comment btn btn-small btn-secundary"><i class="icon-white icon-pencil"></i>','</span>') ?>
...
{ 
    ...
    wp_register_style( 'social_stream', get_template_directory_uri() . '/social_stream.css', array(), '1.0', 'all' );
    
    wp_enqueue_style( 'bootstrap' );
    wp_enqueue_style( 'bootstrap-responsive' );
    wp_enqueue_style( 'wp-bootstrap');
    wp_enqueue_style( 'social_stream');
}
...
function theme_js(){
  ...
  wp_register_script('jmpress', get_template_directory_uri().'/library/js/jmpress.js');
  wp_register_script('jquery.jmslideshow', get_template_directory_uri().'/library/js/jquery.jmslideshow.js');
  ...
  wp_enqueue_script('jquery.jmslideshow', array('jQuery', 'jmpress'), '1.1', true);
}
